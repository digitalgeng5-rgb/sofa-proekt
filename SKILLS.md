...
### Агент-оркестратор «Ричард»

[`.claude/agents/richard.md`](.claude/agents/richard.md) — агент, которому ставишь
задачу, а он: проверяет [базу знаний](knowledge-base/README.md), проводит
инвентаризацию агентов и скиллов, собирает идеальный «микс 11 из 10», доводит
решение через контроль качества (`hard-critic`/`/judge`) и фиксирует апгрейд в
[`knowledge-base/solutions/`](knowledge-base/solutions/README.md). Вызов: попросить
агента `richard` (в Claude Code — через выбор агента или «поставь задачу Ричарду»).
База знаний загружается в папку [`knowledge-base/`](knowledge-base/README.md).
